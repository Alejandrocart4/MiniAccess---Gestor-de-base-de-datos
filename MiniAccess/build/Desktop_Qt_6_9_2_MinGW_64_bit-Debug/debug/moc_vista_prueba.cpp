...
template <> constexpr inline auto VistaPrueba::qt_create_metaobjectdata<qt_meta_tag_ZN11VistaPruebaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'abrirDisenioTabla'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'agregarFilaCampo'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'eliminarFilaCampo'
...
void VistaPrueba::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->abrirDisenioTabla(); break;
        case 1: _t->agregarFilaCampo(); break;
        case 2: _t->eliminarFilaCampo(); break;
        case 3: _t->guardarMeta(); break;
        case 4: _t->onCeldaEditada((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
